...
from widgets.shape_widget import ShapeWidget
...
class DisplayRenderer(QWidget):
    ...
    async def render_layout(self, layout: Dict[str, Any], data: Optional[Dict[str, Any]] = None):
        ...
        # CRITICAL: ALWAYS raise display renderer to front after rendering layout
        # Even if status screen was already cleared, display renderer needs to be on top
